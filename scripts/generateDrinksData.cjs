...
const DRINKS = [
  // ==========================================
  // 1. BEBIDAS COM FUMO AROMÁTICO (SMOKED)
  // ==========================================
  {
    ...
    bar_tools: ['Shaker Cobbler', 'Jigger (Doser)', 'Strainer (Passador fino)', 'Pinça de Bar'],
    ingredients: [
      ...
      { name: 'Gelo em Cubos Grandes', quantity: '4 a 5 cubos' },
      { name: 'Pedra de Gelo Seco Alimentar ou Ramo de Alecrim Tostado', quantity: '1 un' }
    ],
    steps: [
  ...
  },
  {
    ...
    bar_tools: ['Mixing Glass', 'Colher Bailarina (Barspoon)', 'Strainer Julep', 'Campânula de Vidro', 'Maçarico de Bar / Smoking Gun'],
    ingredients: [
      { name: 'Bourbon ou Rye Whiskey de Qualidade', quantity: '60 ml' },
      { name: 'Angostura Aromatic Bitters', quantity: '3 dashes' },
      { name: 'Angostura Orange Bitters', quantity: '1 dash' },
      { name: 'Xarope de Açúcar Demerara (2:1)', quantity: '10 ml' },
      { name: 'Bloco de Gelo Translúcido', quantity: '1 cubo grande' },
      { name: 'Casca (Zest) de Laranja Fresca', quantity: '1 tira longa' },
      { name: 'Aparas de Madeira de Carvalho ou Macieira', quantity: '1 colher de chá' }
    ],
    steps: [
  ...
  },
  {
    ...
    bar_tools: ['Shaker', 'Jigger', 'Passador Hawthorne', 'Maçarico Culinário'],
    ingredients: [
      { name: 'Mezcal Artesanal de Agave Espadín', quantity: '50 ml' },
      { name: 'Sumo de Toranja Rosa Fresco', quantity: '30 ml' },
      { name: 'Sumo de Lima Fresca', quantity: '20 ml' },
      { name: 'Xarope de Agave Orgânico', quantity: '15 ml' },
      { name: 'Sal Fumado ou Sal Negro para a Borda', quantity: 'Para a crosta' },
      { name: 'Ramo de Alecrim Fresco Robusto', quantity: '2 unidades' }
    ],
    steps: [
  ...
  },
  {
    ...
    bar_tools: ['Mixing Glass', 'Colher de Bar', 'Strainer', 'Maçarico Culinário', 'Base de Madeira ou Ardósia'],
    ingredients: [
      { name: 'Bourbon Whiskey', quantity: '50 ml' },
      { name: 'Licor de Laranja (Cointreau ou Triple Sec)', quantity: '20 ml' },
      { name: 'Xarope de Bordo (Maple Syrup) ou Mel', quantity: '10 ml' },
      { name: 'Bitters de Canela ou Angostura', quantity: '2 dashes' },
      { name: 'Pau de Canela Inteiro de Ceilão', quantity: '1 unidade' },
      { name: 'Rodela de Laranja Desidratada', quantity: '1 unidade' }
    ],
    steps: [
  ...
  // ==========================================
  // 2. BEBIDAS ENERGÉTICAS (ENERGY MIXES)
  // ==========================================
  {
    id: 'jager_bomb',
    ...
    bar_tools: ['Copo de Shot clássico', 'Copo Alto Highball ou Tumbler'],
    ingredients: [
      { name: 'Licor de Ervas Jägermeister (a -18°C)', quantity: '45 ml' },
      { name: 'Bebida Energética (Red Bull Original bem gelada)', quantity: '120 ml' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Jigger', 'Colher Bailarina', 'Faca de Guarnição'],
    ingredients: [
      { name: 'Vodka Premium Filtrada', quantity: '50 ml' },
      { name: 'Red Bull Tropical (Amarelo) ou Melancia', quantity: '150 ml' },
      { name: 'Polpa de Maracujá Fresco com Sementes', quantity: '1/2 maracujá' },
      { name: 'Sumo de Lima Fresca', quantity: '15 ml' },
      { name: 'Gelo em Cubos Cristalinos', quantity: 'Até encher o copo' },
      { name: 'Ramo de Hortelã Fresca & Rodela de Lima', quantity: 'Para guarnecer' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Muddler (Pilão de Bar)', 'Colher Bailarina', 'Jigger'],
    ingredients: [
      { name: 'London Dry Gin', quantity: '50 ml' },
      { name: 'Monster Energy Original (Verde)', quantity: '140 ml' },
      { name: 'Lima Fresca em Gomos', quantity: '1/2 unidade' },
      { name: 'Folhas de Hortelã Fresca', quantity: '6 a 8 folhas' },
      { name: 'Xarope de Açúcar de Cana', quantity: '10 ml' },
      { name: 'Gelo Picado', quantity: 'Abundante' }
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      { name: 'Red Bull Tropical ou Sem Açúcar', quantity: '150 ml' },
      { name: 'Sumo de Laranja Natural Prensado', quantity: '60 ml' },
      { name: 'Xarope de Romã (Grenadine) ou Groselha', quantity: '15 ml' },
      { name: 'Sumo de Lima Fresca', quantity: '10 ml' },
      { name: 'Gelo em Cubos', quantity: 'Até preencher o copo' },
      { name: 'Rodela de Laranja & Mirtilos', quantity: 'Para decoração' }
    ],
    steps: [
  ...
  // ==========================================
  {
    ...
    smoking_technique: null,
    bar_tools: ['Copo de Shot', 'Colher Bailarina Invertida (Pouring Spoon)', 'Bico Dosador de Garrafa'],
    ingredients: [
      { name: 'Licor de Café (Kahlúa ou Tía María)', quantity: '20 ml' },
      { name: 'Licor Creme Irlandês (Baileys)', quantity: '20 ml' },
      { name: 'Licor de Laranja (Grand Marnier ou Cointreau)', quantity: '20 ml' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Colher Bailarina de Barman', 'Copo de Shot'],
    ingredients: [
      { name: 'Licor de Café Escuro (Kahlúa ou Patron XO)', quantity: '35 ml' },
      { name: 'Licor Creme Irlandês (Baileys)', quantity: '15 ml' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Shaker', 'Passador Hawthorne', 'Passador de Rede Fina (Double Strainer)'],
    ingredients: [
      { name: 'Vodka', quantity: '30 ml' },
      { name: 'Triple Sec (Cointreau)', quantity: '30 ml' },
      { name: 'Sumo de Lima Fresca Acabado de Espremer', quantity: '30 ml' },
      { name: 'Xarope Simples de Açúcar (Opcional)', quantity: '5 ml' },
      { name: 'Gelo em Cubos', quantity: 'Para bater' }
    ],
    steps: [
  ...
  // ==========================================
  {
    ...
    smoking_technique: null,
    bar_tools: ['Colher Bailarina', 'Vara de Arames Pequena ou Shaker para bater natas', 'Chávena Medidora'],
    ingredients: [
      { name: 'Whiskey Irlandês (ex: Jameson ou Bushmills)', quantity: '40 ml' },
      { name: 'Café de Filtro Forte ou Duplo Expresso Quente', quantity: '100 ml' },
      { name: 'Açúcar Mascavado ou Açúcar Demerara', quantity: '2 colheres de chá' },
      { name: 'Natas Frescas com Alto Teor de Gordura (35%)', quantity: '40 ml' },
      { name: 'Noz-moscada ralada na hora ou Grãos de Café', quantity: 'Para decorar' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Chaleira', 'Colher de Bar', 'Faca de Fruta'],
    ingredients: [
      { name: 'Whiskey Bourbon ou Scotch', quantity: '50 ml' },
      { name: 'Água a Ferver', quantity: '120 ml' },
      { name: 'Mel Puro de Abelhas', quantity: '1 colher de sopa generosa' },
      { name: 'Sumo de Limão Siciliano Fresco', quantity: '20 ml' },
      { name: 'Pau de Canela', quantity: '1 unidade' },
      { name: 'Cravinhos-da-Índia inteiros', quantity: '3 a 4 cravinhos' },
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Tacho / Panela de Inox', 'Concha de Bar', 'Passador'],
    ingredients: [
      { name: 'Vinho Tinto Português Encorpado (Douro ou Alentejo)', quantity: '200 ml por dose' },
      { name: 'Laranja Fresca com Casca (cortada em rodelas)', quantity: '1/2 unidade' },
      { name: 'Pau de Canela', quantity: '1 unidade' },
      { name: 'Anis Estrelado', quantity: '1 estrela inteira' },
      { name: 'Cravinho-da-Índia', quantity: '3 unidades' },
      { name: 'Açúcar Mascavado ou Mel', quantity: '2 colheres de sopa' },
      { name: 'Cálice de Brandy ou Vinho do Porto Tawny (Opcional)', quantity: '20 ml' }
    ],
    steps: [
  ...
  // ==========================================
  // 5. SHORT DRINKS & COCKTAILS CLÁSSICOS
  // ==========================================
  {
    id: 'whiskey_sour',
    ...
    smoking_technique: null,
    bar_tools: ['Shaker de Duas Peças (Boston Shaker)', 'Passador Hawthorne', 'Passador Fino', 'Gotero de Bitters'],
    ingredients: [
      { name: 'Bourbon ou Rye Whiskey', quantity: '60 ml' },
      { name: 'Sumo de Limão Siciliano Fresco', quantity: '30 ml' },
      { name: 'Xarope Simples de Açúcar (1:1)', quantity: '20 ml' },
      { name: 'Clara de Ovo Fresca (ou Aquafaba vegana)', quantity: '20 ml' },
      { name: 'Angostura Bitters', quantity: '3 a 4 gotas no topo' },
      { name: 'Casca de Laranja ou Limão Desidratado', quantity: 'Para guarnição' }
    ],
    steps: [
  ...
  },
  {
    ...
    badge: 'Aristocrático 🍒',
    smoking_technique: null,
    bar_tools: ['Mixing Glass de Cristal', 'Colher Bailarina Longa', 'Julep Strainer'],
    ingredients: [
      { name: 'Rye Whiskey (ou Bourbon de Qualidade)', quantity: '60 ml' },
      { name: 'Vermute Tinto Doce (Rosso di Torino)', quantity: '30 ml' },
      { name: 'Angostura Aromatic Bitters', quantity: '2 dashes' },
      { name: 'Cereja Luxardo Maraschino com Calda', quantity: '1 unidade' },
      { name: 'Zest de Laranja para perfumar', quantity: '1 tira fina' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Colher Bailarina', 'Jigger', 'Descascador de Citrinos'],
    ingredients: [
      { name: 'London Dry Gin', quantity: '30 ml' },
      { name: 'Campari Bitter', quantity: '30 ml' },
      { name: 'Vermute Tinto Doce (Vermouth Rosso)', quantity: '30 ml' },
      { name: 'Cubo Gigante de Gelo', quantity: '1 bloco' },
      { name: 'Casca e Meia-Lua de Laranja Fresca', quantity: '1 unidade' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Shaker', 'Passador Hawthorne', 'Passador Fino', 'Máquina de Café Expresso'],
    ingredients: [
      { name: 'Vodka Premium', quantity: '50 ml' },
      { name: 'Licor de Café (Kahlúa)', quantity: '25 ml' },
      { name: 'Café Expresso Quente Acabado de Tirar', quantity: '30 ml (1 bica curta)' },
      { name: 'Xarope Simples de Açúcar', quantity: '10 ml' },
      { name: 'Cubos Grandes de Gelo', quantity: 'Cheios no Shaker' },
      { name: 'Grãos de Café Torrado', quantity: '3 grãos para o topo' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Shaker', 'Passador Hawthorne', 'Pratinho para Sal'],
    ingredients: [
      { name: 'Tequila Blanco ou Reposado 100% Puro Agave', quantity: '50 ml' },
      { name: 'Licor de Laranja Cointreau (Triple Sec)', quantity: '25 ml' },
      { name: 'Sumo de Lima Fresca Espremido na Hora', quantity: '25 ml' },
      { name: 'Xarope de Agave (Opcional, para equilibrar)', quantity: '5 ml' },
      { name: 'Sal Marinho Fino ou Flor de Sal', quantity: 'Para a borda' },
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Shaker', 'Passador Hawthorne', 'Passador de Malha Fina', 'Jigger'],
    ingredients: [
      { name: 'Rum Branco Cubano (ex: Havana Club 3 Anos)', quantity: '60 ml' },
      { name: 'Sumo de Lima Fresco Acabado de Espremer', quantity: '30 ml' },
      { name: 'Xarope Simples de Açúcar (1:1)', quantity: '20 ml' },
      { name: 'Gelo em Cubos Grandes', quantity: 'Para bater' },
      { name: 'Roda Fina de Lima Desidratada', quantity: 'Para flutuar' }
    ],
    steps: [
  ...
  },
  {
    ...
    bar_tools: ['Colher Bailarina', 'Jigger'],
    ingredients: [
      { name: 'Vinho Espumante Prosecco D.O.C. Brut', quantity: '90 ml (3 partes)' },
      { name: 'Aperol Liqueur', quantity: '60 ml (2 partes)' },
      { name: 'Água com Gás ou Soda', quantity: '30 ml (1 splash)' },
      { name: 'Cubos Grandes de Gelo', quantity: 'Até cima da taça' },
      { name: 'Rodela Grossa de Laranja Fresca', quantity: '1 unidade' },
      { name: 'Azeitona Verde com Caroço (Estilo Veneziano)', quantity: '1 unidade (Opcional)' }
    ],
    steps: [
  ...
  // ==========================================
  {
    ...
    smoking_technique: null,
    bar_tools: ['Muddler de Bar', 'Colher Bailarina', 'Jigger'],
    ingredients: [
      { name: 'Rum Branco Ligeiro', quantity: '50 ml' },
      { name: 'Sumo de Lima Fresco ou 1/2 Lima em Gomos', quantity: '30 ml' },
      { name: 'Açúcar Branco de Cana ou Xarope Simples', quantity: '2 colheres de chá' },
      { name: 'Folhas e Ramos de Hortelã Fresca', quantity: '10 a 12 folhas' },
      { name: 'Água com Gás com Gás Fino', quantity: '60 ml (para completar)' },
      { name: 'Gelo Picado', quantity: 'Abundante' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Caneca de Cobre', 'Colher Bailarina', 'Espremedor de Citrinos'],
    ingredients: [
      { name: 'Vodka Premium', quantity: '50 ml' },
      { name: 'Sumo de Lima Fresca', quantity: '20 ml' },
      { name: 'Ginger Beer de Qualidade (Cerveja de Gengibre Picante)', quantity: '120 ml' },
      { name: 'Gelo Picado', quantity: 'Até encher a caneca' },
      { name: 'Fatias Finas de Gengibre Fresco & Rodela de Lima', quantity: 'Para guarnecer' },
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Muddler de Madeira', 'Tábua de Corte', 'Faca Afiada', 'Shaker (Opcional)'],
    ingredients: [
      { name: 'Cachaça Brasileira Tradicional', quantity: '60 ml' },
      { name: 'Lima Verde Inteira e Suculenta', quantity: '1 unidade' },
      { name: 'Açúcar Branco Refinado', quantity: '2 colheres de sobremesa' },
      { name: 'Gelo Quebrado', quantity: 'Até preencher o copo' }
    ],
    steps: [
  ...
  },
  {
    ...
    badge: 'Perfect Serve 🍸',
    smoking_technique: null,
    bar_tools: ['Colher de Bar Espiralada', 'Descascador de Citrinos', 'Jigger'],
    ingredients: [
      { name: 'Gin Botânico Premium', quantity: '50 ml' },
      { name: 'Água Tónica Premium Fresca (ex: Fever-Tree)', quantity: '150 ml' },
      { name: 'Bagas de Zimbro Ligeiramente Esmagadas', quantity: '3 a 4 unidades' },
      { name: 'Casca (Twist) de Lima e Limão Frescos', quantity: '1 tira' },
      { name: 'Gelo Cristalino', quantity: '6 a 7 cubos grandes' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Jigger', 'Colher de Bar', 'Pratinho de Sal'],
    ingredients: [
      { name: 'Tequila Blanco de Agave', quantity: '50 ml' },
      { name: 'Sumo de Lima Fresca', quantity: '15 ml' },
      { name: 'Refrigerante de Toranja Rosa (ou Sumo de Toranja + Água com Gás)', quantity: '120 ml' },
      { name: 'Sal Marinho ou Flor de Sal', quantity: 'Para a borda' },
      { name: 'Fatia Triangular de Toranja Rosa', quantity: '1 unidade' }
    ],
    steps: [
  ...
  },
  {
    ...
    bar_tools: ['Colher Bailarina', 'Jigger'],
    ingredients: [
      { name: 'Rum Negro Gosling’s Black Seal (ou Rum Escuro Encorpado)', quantity: '50 ml' },
      { name: 'Ginger Beer Picante e Carbonatada', quantity: '120 ml' },
      { name: 'Sumo de Lima Fresca', quantity: '15 ml' },
      { name: 'Rodela Grossa de Lima Fresca', quantity: '1 unidade' },
      { name: 'Cubos de Gelo', quantity: 'Até ao topo' }
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      { name: 'Rum Dourado ou Añejo', quantity: '50 ml' },
      { name: 'Coca-Cola ou Cola de Garrafa de Vidro', quantity: '120 ml' },
      { name: 'Lima Fresca em Quartos', quantity: '1/2 unidade' },
      { name: 'Cubos de Gelo Sólido', quantity: 'Cheios no copo' }
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      { name: 'Vodka', quantity: '45 ml' },
      { name: 'Licor Blue Curaçao', quantity: '25 ml' },
      { name: 'Sumo de Limão Fresco', quantity: '20 ml' },
      { name: 'Refrigerante de Lima-Limão (Sprite/7Up) ou Gasosa', quantity: '90 ml' },
      { name: 'Rodela de Laranja ou Limão & Cereja', quantity: 'Para guarnição' }
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      { name: 'Tequila Blanco ou Reposado', quantity: '50 ml' },
      { name: 'Sumo de Laranja Fresco', quantity: '120 ml' },
      { name: 'Xarope de Groselha ou Grenadine', quantity: '15 ml' },
      { name: 'Cubos de Gelo', quantity: 'Até cima do copo' },
      { name: 'Rodela de Laranja & Cereja Maraschino', quantity: 'Para decorar' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Liquidificador de Bar ou Shaker', 'Faca de Fruta'],
    ingredients: [
      { name: 'Rum Branco Caribenho', quantity: '50 ml' },
      { name: 'Creme de Coco (ex: Coco López) ou Leite de Coco Gordo', quantity: '40 ml' },
      { name: 'Sumo de Ananás Natural', quantity: '90 ml' },
      { name: 'Sumo de Lima Fresco', quantity: '10 ml' },
      { name: 'Triângulo de Ananás Fresco & Folhas', quantity: 'Para decoração' },
      { name: 'Cereja Maraschino', quantity: '1 unidade' }
    ],
    steps: [
  ...
  // ==========================================
  // 7. MOCKTAILS & VIRGIN DRINKS (SEM ÁLCOOL)
  // ==========================================
  {
    id: 'virgin_mojito',
    ...
    bar_tools: ['Muddler', 'Colher Bailarina'],
    ingredients: [
      { name: 'Lima Fresca cortada em gomos', quantity: '1 unidade' },
      { name: 'Folhas de Hortelã Fresca', quantity: '12 folhas' },
      { name: 'Açúcar Mascavado ou Xarope de Cana', quantity: '2 colheres de chá' },
      { name: 'Sumo de Maçã Claro ou Ginger Ale', quantity: '50 ml' },
      { name: 'Água com Gás', quantity: 'Para completar' },
      { name: 'Gelo Picado', quantity: 'Abundante' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Liquidificador', 'Faca de Guarnição'],
    ingredients: [
      { name: 'Sumo de Ananás 100% Fruta', quantity: '140 ml' },
      { name: 'Creme ou Leite de Coco Gordo', quantity: '60 ml' },
      { name: 'Natas Frescas Líquidas ou Xarope de Coco', quantity: '20 ml' },
      { name: 'Sumo de Lima Fresco', quantity: '10 ml' },
      { name: 'Gelo', quantity: '1 chávena de cubos' },
      { name: 'Fatia de Ananás & Cereja', quantity: 'Para decoração' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Liquidificador Potente', 'Tábua de Fruta'],
    ingredients: [
      { name: 'Morangos Frescos Maduros (ou congelados)', quantity: '150 g' },
      { name: 'Sumo de Lima Fresco', quantity: '30 ml' },
      { name: 'Xarope Simples de Açúcar ou Mel', quantity: '25 ml' },
      { name: 'Sumo de Maçã ou Água de Coco', quantity: '40 ml' },
      { name: 'Gelo em Cubos', quantity: '1 chávena cheia' },
      { name: 'Morango Inteiro com Folha', quantity: 'Para decorar' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Shaker', 'Passador', 'Pratinho de Açúcar e Groselha'],
    ingredients: [
      ...
      { name: 'Açúcar Cristalino Rosa ou Branco', quantity: 'Para a borda' }
    ],
    steps: [
  ...
  },
  {
    ...
    badge: 'Mágica & Viral 🔮',
    smoking_technique: null,
    bar_tools: ['Infusor de Chá', 'Jigger', 'Jarrinha Pequena de Lima'],
    ingredients: [
      { name: 'Chá Azul de Flores de Butterfly Pea (Frio)', quantity: '100 ml' },
      { name: 'Xarope Simples ou de Flor de Sabugueiro', quantity: '20 ml' },
      { name: 'Sumo de Lima Fresco (Servido à parte numa jarrinha)', quantity: '30 ml' },
      { name: 'Água Tónica ou Água com Gás', quantity: '60 ml' },
      { name: 'Glitter Alimentar Comestível (Opcional)', quantity: '1 pitada' },
      { name: 'Cubos de Gelo', quantity: 'Até ao topo' }
    ],
    steps: [
  ...
  // ==========================================
  // 8. SOFT DRINKS & REFRESCOS ARTESANAIS
  // ==========================================
  {
    id: 'limonada_suica',
    ...
    badge: 'Ultra Cremosa 🥛',
    smoking_technique: null,
    bar_tools: ['Liquidificador Potente', 'Passador de Rede Médio', 'Tábua e Faca'],
    ingredients: [
      { name: 'Limões Taiti Frescos Lavados', quantity: '2 unidades' },
      { name: 'Leite Condensado', quantity: '4 a 5 colheres de sopa' },
      { name: 'Água Gelada Mineral', quantity: '500 ml' },
      { name: 'Cubos de Gelo', quantity: '1 chávena' },
      { name: 'Folhas de Hortelã Fresca', quantity: 'Para finalizar' }
    ],
    steps: [
  ...
  },
  {
    ...
    badge: 'Detox Natural 🌿',
    smoking_technique: null,
    bar_tools: ['Jarro de Vidro', 'Colher de Pau / Bar', 'Espremedor'],
    ingredients: [
      { name: 'Sumo de Limão Fresco', quantity: '60 ml (cerca de 2 limões)' },
      { name: 'Água Mineral com ou sem Gás', quantity: '200 ml' },
      { name: 'Folhas de Hortelã Fresca', quantity: '8 a 10 folhas' },
      { name: 'Gengibre Fresco Ralado', quantity: '1/2 colher de chá' },
      { name: 'Mel Puro ou Açúcar Mascavado', quantity: '2 colheres de sopa' },
      { name: 'Gelo em Cubos', quantity: 'Abundante' }
    ],
    steps: [
  ...
  },
  {
    ...
    bar_tools: ['Muddler', 'Colher Bailarina'],
    ingredients: [
      { name: 'Frutos Vermelhos Mistos (Morangos, Framboesas, Amoras)', quantity: '80 g' },
      { name: 'Sumo de Limão Siciliano Fresco', quantity: '35 ml' },
      { name: 'Xarope Simples ou Açúcar de Cana', quantity: '25 ml' },
      { name: 'Folhas de Manjericão Fresco', quantity: '3 a 4 folhas' },
      { name: 'Água com Gás ou Água Mineral Fresca', quantity: '150 ml' },
      { name: 'Gelo', quantity: 'Abundante' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Espremedor de Alho / Prensa de Gengibre', 'Colher Bailarina', 'Jigger'],
    ingredients: [
      { name: 'Sumo Puro de Gengibre Fresco Prensado', quantity: '25 ml' },
      { name: 'Mel Biológico Diluído (Honey Syrup 1:1)', quantity: '25 ml' },
      { name: 'Sumo de Lima Fresco', quantity: '20 ml' },
      { name: 'Água com Gás com Alta Carbonatação', quantity: '150 ml' },
      { name: 'Fatias Finas de Gengibre Cristalizado ou Natural', quantity: 'Para guarnecer' },
      { name: 'Raminho de Alecrim', quantity: '1 unidade' }
    ],
    steps: [
  ...
  },
  {
    ...
    badge: '100% Natural 🍑',
    smoking_technique: null,
    bar_tools: ['Chaleira / Bule', 'Passador', 'Jarro de Serviço'],
    ingredients: [
      { name: 'Chá Preto Ceylon ou Earl Grey Infundido e Frio', quantity: '180 ml' },
      { name: 'Puré ou Néctar de Pêssego Maduro', quantity: '50 ml' },
      { name: 'Sumo de Limão Fresco', quantity: '15 ml' },
      { name: 'Xarope de Açúcar de Cana ou Mel', quantity: '15 ml' },
      { name: 'Fatias de Pêssego Fresco', quantity: '3 fatias' },
      { name: 'Folhas de Hortelã Fresca', quantity: 'Para guarnição' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Liquidificador ou Extrator Cold Press', 'Passador'],
    ingredients: [
      { name: 'Maçã Verde Granny Smith com Casca', quantity: '1 unidade' },
      { name: 'Pepino Médio com Casca', quantity: '1/2 unidade' },
      { name: 'Folhas de Espinafre Frescas', quantity: '1 mão cheia' },
      { name: 'Sumo de Lima Fresca', quantity: '20 ml' },
      { name: 'Gengibre Fresco', quantity: '1 pedaço de 1 cm' },
      { name: 'Água de Coco ou Água Mineral Gelada', quantity: '150 ml' }
    ],
    steps: [
  ...
  },
  {
    ...
    badge: 'Viral & Doce ☕',
    smoking_technique: null,
    bar_tools: ['Batedor de Arame ou Mini Batedeira Elétrica', 'Colher'],
    ingredients: [
      { name: 'Café Solúvel de Boa Qualidade', quantity: '2 colheres de sopa' },
      { name: 'Açúcar Branco ou Mascavado', quantity: '2 colheres de sopa' },
      { name: 'Água a Ferver', quantity: '2 colheres de sopa' },
      { name: 'Leite Fresco Gordo ou Bebida Vegetal (Aveia/Amêndoa)', quantity: '200 ml' },
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Liquidificador', 'Colher'],
    ingredients: [
      { name: 'Manga Fresca Madura em Cubos', quantity: '1 unidade grande' },
      { name: 'Iogurte Grego Natural sem Açúcar', quantity: '120 g' },
      { name: 'Sumo de Laranja ou Leite de Amêndoa', quantity: '80 ml' },
      { name: 'Sementes de Chia', quantity: '1 colher de chá' },
      { name: 'Mel Puro', quantity: '1 colher de chá' },
      { name: 'Folhas de Hortelã Fresca', quantity: 'Para guarnição' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Liquidificador', 'Almofariz para Cardamomo'],
    ingredients: [
      { name: 'Polpa de Manga Doce (tipo Alphonso ou Palmer)', quantity: '200 g' },
      { name: 'Iogurte Natural Cremoso', quantity: '150 g' },
      { name: 'Leite Fresco Gordo', quantity: '60 ml' },
      { name: 'Açúcar ou Xarope Simples', quantity: '1 a 2 colheres de sopa' },
      { name: 'Sementes de Cardamomo Moídas na Hora', quantity: '1 pitada generosa' },
      { name: 'Pistácios Picados', quantity: 'Para decorar o topo' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Liquidificador', 'Colher de Gelado'],
    ingredients: [
      { name: 'Morangos Frescos Maduros', quantity: '150 g' },
      { name: 'Gelado Artesanal de Baunilha ou Nata', quantity: '3 bolas generosas' },
      { name: 'Leite Gordo Bem Frio', quantity: '120 ml' },
      { name: 'Chantilly Batido em Spray ou Caseiro', quantity: 'Para o topo' },
      { name: 'Calda de Morango', quantity: 'Para o interior do copo' }
    ],
    steps: [
  ...
  },
  {
    ...
    badge: 'Floral & Rubi 🌺',
    smoking_technique: null,
    bar_tools: ['Infusor / Chaleira', 'Passador', 'Jarro de Vidro'],
    ingredients: [
      { name: 'Flores Secas de Hibisco Biológico', quantity: '2 colheres de sopa' },
      { name: 'Água a Ferver', quantity: '250 ml' },
      { name: 'Sumo e Meia-Lua de Laranja Fresca', quantity: '30 ml' },
      { name: 'Mel Puro ou Xarope de Agave', quantity: '1 a 2 colheres de sopa' },
      { name: 'Amoras ou Framboesas Frescas', quantity: 'Para guarnecer' },
  ...
  // ==========================================
  // 9. TRADIÇÃO PORTUGUESA (PORTUGUESE HERITAGE)
  // ==========================================
  {
    id: 'poncha',
    ...
    smoking_technique: null,
    bar_tools: ['Caralhinho (Mexelote de Madeira da Madeira)', 'Jarro de Poncha', 'Descascador de Citrinos'],
    ingredients: [
      { name: 'Aguardente de Cana-de-Açúcar da Madeira (50% vol)', quantity: '50 ml' },
      { name: 'Mel de Abelhas Puro da Madeira ou Açúcar de Cana', quantity: '30 ml' },
      { name: 'Sumo de Limão Regional Fresco', quantity: '30 ml' },
      { name: 'Casca Fina de Limão e Laranja', quantity: 'Para pilar no fundo' }
    ],
    steps: [
  ...
  },
  {
    ...
    bar_tools: ['Colher Bailarina', 'Jigger'],
    ingredients: [
      { name: 'Vinho do Porto Branco (Seco ou Extra Seco)', quantity: '60 ml' },
      { name: 'Água Tónica Premium Fresca', quantity: '120 ml' },
      { name: 'Rodela Grossa de Limão Fresco', quantity: '1 unidade' },
      { name: 'Ramo de Hortelã Fresca', quantity: '1 unidade' },
      { name: 'Gelo em Cubos Grandes', quantity: 'Abundante' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Jarro Grande de Vidro', 'Colher de Pau Longa', 'Tábua de Fruta'],
    ingredients: [
      { name: 'Vinho Tinto Jovem e Frutado', quantity: '750 ml (1 garrafa)' },
      { name: 'Refrigerante Gasosa ou 7Up', quantity: '250 ml' },
      { name: 'Licor Beirão Tradicional', quantity: '50 ml' },
      { name: 'Brandy ou Aguardente Vínica', quantity: '30 ml' },
      { name: 'Laranjas Frescas cortadas em meias-luas', quantity: '1 unidade' },
      { name: 'Maçã Vermelha em cubinhos', quantity: '1 unidade' },
      { name: 'Pau de Canela', quantity: '2 unidades' },
      { name: 'Açúcar Mascavado', quantity: '2 colheres de sopa' }
    ],
    steps: [
  ...
  },
  {
    ...
    smoking_technique: null,
    bar_tools: ['Jarro de Sangria', 'Colher Longa'],
    ingredients: [
      { name: 'Vinho Espumante Português Meio-Seco ou Bruto', quantity: '750 ml' },
      { name: 'Vinho Branco Verde ou do Alentejo', quantity: '250 ml' },
      { name: 'Licor Cointreau ou Triple Sec', quantity: '50 ml' },
      { name: 'Frutos Vermelhos Frescos (Morangos fatiados e Framboesas)', quantity: '150 g' },
      { name: 'Maçã Verde Granny Smith em cubinhos', quantity: '1 unidade' },
      { name: 'Ramos de Hortelã Fresca', quantity: '6 a 8 folhas' },
      { name: 'Refrigerante de Lima-Limão (Sprite/7Up)', quantity: '200 ml' },
      { name: 'Gelo', quantity: 'Abundante' }
    ],
    steps: [
  ...
  },
  {
    ...
    badge: 'Óbidos & Lisboa 🍫',
    smoking_technique: null,
    bar_tools: ['Garrafa de Ginjinha Tradicional com Frutos', 'Copo Comestível de Chocolate'],
    ingredients: [
      { name: 'Licor de Ginjinha Tradicional Portuguesa', quantity: '40 ml' },
      { name: 'Ginja Fruto Macerada da Garrafa ("Com Elas")', quantity: '1 a 2 ginjas' },
      { name: 'Copo Comestível de Chocolate Negro 70%', quantity: '1 unidade' }
    ],
    steps: [
...
const fileContent = `export const ALCOHOL_FILTERS = ${JSON.stringify(ALCOHOL_FILTERS, null, 2)};

export const DRINK_CATEGORIES = ${JSON.stringify(DRINK_CATEGORIES, null, 2)};

export const DRINKS = ${JSON.stringify(DRINKS, null, 2)};
`;

fs.writeFileSync(path.join(__dirname, '../src/data/drinksData.js'), fileContent, 'utf8');
console.log('Successfully generated drinksData.js with ' + DRINKS.length + ' drinks across all categories!');
